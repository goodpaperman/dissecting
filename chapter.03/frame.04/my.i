...
struct CRuntimeClass
{
    ...
    int m_nObjectSize; 
    int m_wSchema; 
    CObject* (_stdcall* m_pfnCreateObject)(); 
...
public:
    ...
    public: static CRuntimeClass classCObject; virtual CRuntimeClass* GetRuntimeClass() const;
}; 
...
public:
    ...
    public: static CRuntimeClass classCCmdTarget; virtual CRuntimeClass* GetRuntimeClass() const;
}; 
...
public:
    ...
    public: static CRuntimeClass classCWinThread; virtual CRuntimeClass* GetRuntimeClass() const;
}; 
...
public:
    ...
    public: static CRuntimeClass classCWinApp; virtual CRuntimeClass* GetRuntimeClass() const;
}; 
...
public:
    ...
    public: static CRuntimeClass classCDocument; virtual CRuntimeClass* GetRuntimeClass() const;
}; 
...
public:
    ...
    virtual int Create(); 
    int CreateEx(); 
    virtual int PreCreateWindow(); 

    public: static CRuntimeClass classCWnd; virtual CRuntimeClass* GetRuntimeClass() const;
}; 
...
public:
    ...
    public: static CRuntimeClass classCFrameWnd; virtual CRuntimeClass* GetRuntimeClass() const;
}; 
...
public:
    ...
    public: static CRuntimeClass classCMyWinApp; virtual CRuntimeClass* GetRuntimeClass() const;
}; 
...
public:
    ...
    public: static CRuntimeClass classCMyFrameWnd; virtual CRuntimeClass* GetRuntimeClass() const;
}; 
...
public:
    ...
    public: static CRuntimeClass classCMyView; virtual CRuntimeClass* GetRuntimeClass() const;
}; 
...
public:
    ...
    public: static CRuntimeClass classCMyDoc; virtual CRuntimeClass* GetRuntimeClass() const;
}; 
...
static char _lpszCMyWinApp[] = "CMyWinApp"; CRuntimeClass CMyWinApp::classCMyWinApp = { _lpszCMyWinApp, sizeof(CMyWinApp), 0xFFFF, 0, (&CWinApp::classCWinApp), 0 }; static AFX_CLASSINIT _init_CMyWinApp((&CMyWinApp::classCMyWinApp)); CRuntimeClass* CMyWinApp::GetRuntimeClass() const { return (&CMyWinApp::classCMyWinApp); }
static char _lpszCMyFrameWnd[] = "CMyFrameWnd"; CRuntimeClass CMyFrameWnd::classCMyFrameWnd = { _lpszCMyFrameWnd, sizeof(CMyFrameWnd), 0xFFFF, 0, (&CFrameWnd::classCFrameWnd), 0 }; static AFX_CLASSINIT _init_CMyFrameWnd((&CMyFrameWnd::classCMyFrameWnd)); CRuntimeClass* CMyFrameWnd::GetRuntimeClass() const { return (&CMyFrameWnd::classCMyFrameWnd); }
static char _lpszCMyView[] = "CMyView"; CRuntimeClass CMyView::classCMyView = { _lpszCMyView, sizeof(CMyView), 0xFFFF, 0, (&CView::classCView), 0 }; static AFX_CLASSINIT _init_CMyView((&CMyView::classCMyView)); CRuntimeClass* CMyView::GetRuntimeClass() const { return (&CMyView::classCMyView); }
static char _lpszCMyDoc[] = "CMyDoc"; CRuntimeClass CMyDoc::classCMyDoc = { _lpszCMyDoc, sizeof(CMyDoc), 0xFFFF, 0, (&CDocument::classCDocument), 0 }; static AFX_CLASSINIT _init_CMyDoc((&CMyDoc::classCMyDoc)); CRuntimeClass* CMyDoc::GetRuntimeClass() const { return (&CMyDoc::classCMyDoc); }

int CMyWinApp::InitInstance()
{
...
void main()
{
    ...
    cout << pDoc->GetRuntimeClass()->m_lpszClassName << " is kind of class [" << "CMyDoc" << "] : " << pDoc->IsKindOf((&CMyDoc::classCMyDoc)) << endl; 
    cout << pDoc->GetRuntimeClass()->m_lpszClassName << " is kind of class [" << "CDocument" << "] : " << pDoc->IsKindOf((&CDocument::classCDocument)) << endl; 
    cout << pDoc->GetRuntimeClass()->m_lpszClassName << " is kind of class [" << "CCmdTarget" << "] : " << pDoc->IsKindOf((&CCmdTarget::classCCmdTarget)) << endl; 
    cout << pDoc->GetRuntimeClass()->m_lpszClassName << " is kind of class [" << "CObject" << "] : " << pDoc->IsKindOf((&CObject::classCObject)) << endl; 
    cout << pDoc->GetRuntimeClass()->m_lpszClassName << " is kind of class [" << "CWinApp" << "] : " << pDoc->IsKindOf((&CWinApp::classCWinApp)) << endl; 
    cout << pDoc->GetRuntimeClass()->m_lpszClassName << " is kind of class [" << "CView" << "] : " << pDoc->IsKindOf((&CView::classCView)) << endl; 

    cout << pView->GetRuntimeClass()->m_lpszClassName << " is kind of class [" << "CView" << "] : " << pView->IsKindOf((&CView::classCView)) << endl; 
    cout << pView->GetRuntimeClass()->m_lpszClassName << " is kind of class [" << "CObject" << "] : " << pView->IsKindOf((&CObject::classCObject)) << endl; 
    cout << pView->GetRuntimeClass()->m_lpszClassName << " is kind of class [" << "CWnd" << "] : " << pView->IsKindOf((&CWnd::classCWnd)) << endl; 
    cout << pView->GetRuntimeClass()->m_lpszClassName << " is kind of class [" << "CFrameWnd" << "] : " << pView->IsKindOf((&CFrameWnd::classCFrameWnd)) << endl; 

    cout << pWnd->GetRuntimeClass()->m_lpszClassName << " is kind of class [" << "CFrameWnd" << "] : " << pWnd->IsKindOf((&CFrameWnd::classCFrameWnd)) << endl; 
    cout << pWnd->GetRuntimeClass()->m_lpszClassName << " is kind of class [" << "CWnd" << "] : " << pWnd->IsKindOf((&CWnd::classCWnd)) << endl; 
    cout << pWnd->GetRuntimeClass()->m_lpszClassName << " is kind of class [" << "CObject" << "] : " << pWnd->IsKindOf((&CObject::classCObject)) << endl; 
    cout << pWnd->GetRuntimeClass()->m_lpszClassName << " is kind of class [" << "CDocument" << "] : " << pWnd->IsKindOf((&CDocument::classCDocument)) << endl; 
