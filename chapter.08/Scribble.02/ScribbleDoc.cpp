...
CStroke* CScribbleDoc::NewStroke()
{
    ...
    CRectangle* pRectItem = new CRectangle(CRect(0x11, 0x22, 0x33, 0x44)); 
    CCircle* pCircleItem = new CCircle(CPoint(0x55, 0x66), 0x77); 
    m_strokeList.AddTail(pStrokeItem); 
    m_strokeList.AddTail(pRectItem); 
    m_strokeList.AddTail(pCircleItem); 
