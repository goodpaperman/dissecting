========================================================================
                    CUSTOM APPWIZARD: Top Studio
========================================================================


AppWizard has created a Top Studio DLL for you.  This DLL is the starting point
...
you build Top Studio.awx, it will automatically be copied to your Template
...
Top StudioAw.h, Top StudioAw.cpp - the CCustomAppWiz class
    These files contain your CCustomAppWiz-derived class,
    CTopStudioAppWiz.  This class contains virtual member functions which
...
Template\
    ...
    import that file as a "TEMPLATE" custom resource into Top Studio.rc.  Be
...
StdAfx.h, StdAfx.cpp
    ...
    named Top Studio.pch and a precompiled types file named StdAfx.obj.
